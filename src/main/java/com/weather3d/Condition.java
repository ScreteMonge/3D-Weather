...
public enum Condition {
    ...
    Condition(String name, String imageFile, boolean hasPrecipitation, int modelVariety, boolean hasSound, SoundEffect soundEffect, int objLow, int objMed, int objHigh, int objExtreme, int objGameCrashing, int changeRate)
    {
        this.name = name;
